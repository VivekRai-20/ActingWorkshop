...
interface PaymentConfirmationProps {
  ...
  orderId: string;
  amount: number;
  onSubmit: (customerDetails: CustomerDetails) => Promise<SubmitResponse>;
}
...
const PaymentConfirmation = ({ paymentId, orderId, amount, onSubmit }: PaymentConfirmationProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to submit details. Please try again. If the problem persists, please contact support.";
